...
\begin{definition}[Vektorový podprostor]
    ...
    \begin{enumerate}
        \item $\vec{u}, \vec{v} \in \mathcal{W} \Rightarrow \vec{u} + \vec{v} \in \mathcal{W}$ \hfill \uv{Uzavřenost} vůči aditivní operaci
        \item $\vec{u} \in \mathcal{W}, a \in F \Rightarrow  a \cdot \vec{u} \in \mathcal{W}$ \hfill \uv{Uzavřenost} vůči operaci násobení skalárem
    \end{enumerate}
